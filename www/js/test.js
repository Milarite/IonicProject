...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://project-7113158678547793642.firebaseio.com/"),
    
    refUser = new Firebase("https://project-7113158678547793642.firebaseio.com/jobs/users"),
 
    refMenu = new Firebase("https://project-7113158678547793642.firebaseio.com/jobs/messages");
  return {
    ref: function() {
      return ref;
    },
